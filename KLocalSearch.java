...
public class KLocalSearch {
    ...
    private static ArrayList<ArrayList<Integer>> initializeClustering(int num_nodes, int k) {
    ...
    public static void main(String args[]) {
        ...
        int[] k_vals = {10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 110000, 120000, 130000, 140000, 150000};
	...
	long hybridScoreTotal = 0;
        ...
        ArrayList<ArrayList<Integer>> pivot_result = k_local_search_network(prob_matrix, k, 0.05);
        ...
        ArrayList<ArrayList<Integer>> fill_result = k_local_search_network(prob_matrix, k, 0.1);
        ...
        ArrayList<ArrayList<Integer>> rand_result = k_local_search_network(prob_matrix, k, 0.15);
        ...
        ArrayList<ArrayList<Integer>> blend_result = k_local_search_network(prob_matrix, k, 0.2);
        ...
        ArrayList<ArrayList<Integer>> fix = k_local_search_network(prob_matrix, k, 0.25);
        ...
        System.out.println("LocalSearch(0.05) times: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(pivotTimes[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.05) scores: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(pivotScores[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.10) times: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(fillTimes[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.10) scores: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(fillScores[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.15) times: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(randTimes[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.15) scores: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(randScores[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.20) times: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(blendTimes[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.20) scores: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(blendScores[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.25)  times: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(hybridTimes[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LocalSearch(0.25) scores: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(hybridScores[i] + " ");
        System.out.println();
        System.out.println();

        System.out.println("Average LocalSearch(0.05) time: " + pivotTimeTotal / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.10) time: " + fillTimeTotal / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.15) time: " + randTimeTotal / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.20) time: " + blendTimeTotal / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.25) time: " + hybridTimeTotal / ((double) ROUNDS));
        System.out.println();
        System.out.println("Average LocalSearch(0.05) score: " + pivotScoreTotal / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.10) score: " + fillScoreTotal / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.15) score: " + randScoreTotal / ((double) ROUNDS));
	System.out.println("Average LocalSearch(0.20) score: " + blendScoreTotal / ((double) ROUNDS));
	System.out.println("Average LocalSearch(0.25) score: " + hybridScoreTotal / ((double) ROUNDS));
        System.out.println();
        System.out.println("Average LocalSearch(0.05) num clusters: " + pivotNumClusters / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.10) num clusters: " + fillNumClusters / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.15) num clusters: " + randNumClusters / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.20) num clusters: " + blendNumClusters / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.25) num clusters: " + hybridNumClusters / ((double) ROUNDS));
        System.out.println();
        System.out.println("Average LocalSearch(0.05) max cluster size: " + largestPivotCluster / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.10) max cluster size: " + largestFillCluster / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.15) max cluster size: " + largestRandCluster / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.20) max cluster size: " + largestBlendCluster / ((double) ROUNDS));
        System.out.println("Average LocalSearch(0.25) max cluster size: " + largestHybridCluster / ((double) ROUNDS));     
        System.out.println();
        }
